...
HzwCityPicker.prototype = {
    ...
    addProvinceEvent: function() {
        var b = this;
        b.province_wrap.on('click', '.hzw-province',
        function() {
            var a = $(this);
    ...
    addCityEvent: function() {
        var g = this;
        g.hot_city.on('click', '.hzw-hot-city',
        function() {
            var a = $(this);
            var b = a.data('id');
            var c = a.data('name');
        ...
        g.province_wrap.on('click', '.hzw-city',
        function() {
            var a = $(this);
            var b = a.data('id');
            var c = a.data('name');
